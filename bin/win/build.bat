...
if [%1]==[] (
    cls & ..\..\gradlew clean bootJar "-Dorg.gradle.jvmargs=-Xmx4g" --project-dir ./../../ -Papi-docs
) else (
    if [%2]==[] (
        cls & ..\..\gradlew clean bootJar "-Dorg.gradle.jvmargs=-Xmx4g" --project-dir ./../../ -Papi-docs -P%1
    ) else (
        if [%3]==[] (
            cls & ..\..\gradlew clean bootJar "-Dorg.gradle.jvmargs=-Xmx4g" --project-dir ./../../ -Papi-docs -P%1 -P%2
        ) else (
            cls & ..\..\gradlew clean bootJar "-Dorg.gradle.jvmargs=-Xmx4g" --project-dir ./../../ -Papi-docs -P%1 -P%2 -P%3
        )
    )
)
