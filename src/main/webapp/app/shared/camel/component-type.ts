...
export class Components {
    types = [
        ...
        },
        {
            ...
            description: 'Expose WebSocket steps using the Atmosphere framework.',
            deprecated: false,
            deprecationNote: '',
            firstVersion: '2.14.0',
            label: 'websocket',
        ...
        },
        {
            ...
            name: 'browse',
            title: 'Browse',
            description: 'Inspect the messages received on steps supporting BrowsableEndpoint.',
            deprecated: false,
            firstVersion: '1.3.0',
        ...
        },
        {
            ...
            title: 'DataSet Test',
            description:
                'Extends the mock component by pulling messages from another step on startup to set the expected message bodies.',
            deprecated: false,
            firstVersion: '1.3.0',
            label: 'core,testing',
        ...
        },
        {
            ...
            name: 'direct',
            title: 'Direct',
            description: 'Call another step from the same Camel Context synchronously.',
            deprecated: false,
            firstVersion: '1.0.0',
            label: 'core,step',
        ...
        },
        {
            ...
            name: 'direct-vm',
            title: 'Direct VM',
            description: 'Call another step from any Camel Context in the same JVM synchronously.',
            deprecated: false,
            firstVersion: '2.10.0',
            label: 'core,step',
        ...
        },
        {
            ...
            name: 'grpc',
            title: 'gRPC',
            description: 'Expose gRPC steps and access external gRPC steps.',
            deprecated: false,
            firstVersion: '2.19.0',
            label: 'rpc',
        ...
        },
        {
            ...
            name: 'jetty',
            title: 'Jetty',
            description: 'Expose HTTP steps using Jetty 9.',
            deprecated: false,
            deprecationNote: '',
            firstVersion: '1.2.0',
            label: 'http',
        ...
        },
        {
            ...
            title: 'Master',
            description:
                'Have only a single consumer in a cluster consuming from a given step; with automatic failover if the JVM dies.',
            deprecated: false,
            firstVersion: '2.20.0',
            label: 'clustering',
        ...
        },
        {
            ...
            name: 'platform-http',
            title: 'Platform HTTP',
            description: 'Expose HTTP steps using the HTTP server available in the current platform.',
            deprecated: false,
            firstVersion: '3.0.0',
            label: 'http',
        ...
        },
        {
            ...
            name: 'ref',
            title: 'Ref',
            description: 'Route messages to an step looked up dynamically by name in the Camel Registry.',
            deprecated: false,
            firstVersion: '1.2.0',
            label: 'core,step',
        ...
        },
        {
            ...
            name: 'resteasy',
            title: 'Resteasy',
            description: 'Expose REST steps and access external REST servers.',
            deprecated: false,
            deprecationNote: '',
            firstVersion: '3.4.0',
            label: 'rest',
        ...
        },
        {
            ...
            name: 'seda',
            title: 'SEDA',
            description: 'Asynchronously call another step from any Camel Context in the same JVM.',
            deprecated: false,
            firstVersion: '1.1.0',
            label: 'core,step',
        ...
        },
        {
            ...
            name: 'service',
            title: 'Service',
            description: 'Register a Camel step to a Service Registry (such as Consul, Etcd) and delegate to it.',
            deprecated: false,
            firstVersion: '2.22.0',
            label: 'cloud',
        ...
        },
        {
            ...
            name: 'stub',
            title: 'Stub',
            description: 'Stub out any physical steps while in development or testing.',
            deprecated: false,
            firstVersion: '2.10.0',
            label: 'core,testing',
        ...
        },
        {
            ...
            name: 'undertow',
            title: 'Undertow',
            description: 'Expose HTTP and WebSocket steps and access external HTTP/WebSocket servers.',
            deprecated: false,
            firstVersion: '2.16.0',
        ...
        },
        {
            ...
            description: 'Expose WebSocket steps and connect to remote WebSocket servers using Vert.x',
            deprecated: false,
            firstVersion: '3.5.0',
            label: 'websocket',
        ...
        },
        {
            ...
            name: 'vm',
            title: 'VM',
            description: 'Call another step in the same CamelContext asynchronously.',
            deprecated: false,
            firstVersion: '1.1.0',
            label: 'core,step',
        ...
        },
        {
            ...
            name: 'webhook',
            title: 'Webhook',
            description: 'Expose webhook steps to receive push notifications for other Camel components.',
            deprecated: false,
            firstVersion: '3.0.0',
            label: 'cloud',
        ...
        },
        {
            ...
            description: 'Expose websocket steps using Jetty.',
            deprecated: false,
            firstVersion: '2.10.0',
            label: 'websocket',
        ...
        },
        {
            ...
            description: 'Expose websocket steps using JSR356.',
            deprecated: false,
            firstVersion: '2.23.0',
            label: 'http',
