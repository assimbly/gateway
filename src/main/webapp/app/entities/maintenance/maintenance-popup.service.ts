        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.maintenanceService.find(id).subscribe((maintenance) => {
                    maintenance.startTime = this.datePipe
                        .transform(maintenance.startTime, 'yyyy-MM-ddTHH:mm:ss');
                    maintenance.endTime = this.datePipe
                        .transform(maintenance.endTime, 'yyyy-MM-ddTHH:mm:ss');
