...
public class Maintenance implements Serializable {
    ...
    public Maintenance flows(Set<Flow> flows) {
        this.flows = flows;
        return this;
    }

    public Maintenance addFlow(Flow flow) {
        this.flows.add(flow);
        flow.getMaintenances().add(this);
        return this;
    }

    public Maintenance removeFlow(Flow flow) {
        this.flows.remove(flow);
        flow.getMaintenances().remove(this);
        return this;
    }
