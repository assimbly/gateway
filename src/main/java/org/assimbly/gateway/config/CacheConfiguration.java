...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(org.assimbly.gateway.domain.Gateway.class.getName() + ".camelRoutes", jcacheConfiguration);
            ...
            cm.createCache(org.assimbly.gateway.domain.CamelRoute.class.getName(), jcacheConfiguration);
            cm.createCache(org.assimbly.gateway.domain.CamelRoute.class.getName() + ".endpointTos", jcacheConfiguration);
            ...
            cm.createCache(org.assimbly.gateway.domain.CamelRoute.class.getName() + ".toEndpoints", jcacheConfiguration);
