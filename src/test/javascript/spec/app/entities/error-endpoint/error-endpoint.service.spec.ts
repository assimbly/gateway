...
describe('Service Tests', () => {
    ...
    describe('ErrorEndpoint Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ErrorEndpointService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/error-endpoints';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ErrorEndpoint', () => {

                let entity: ErrorEndpoint;
                service.find(123).subscribe((_entity: ErrorEndpoint) => {
                    entity = _entity;
                });
