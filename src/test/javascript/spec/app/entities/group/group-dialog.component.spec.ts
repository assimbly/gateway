...
import { GroupDialogComponent } from '../../../../../../main/webapp/app/entities/group/group-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Group Management Dialog Component', () => {
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(GroupDialogComponent, '')
            .compileComponents();
        }));
